# DCL (Data Control Language) là nhóm các câu lệnh SQL được sử dụng để quản lý quyền hạn (permissions) và kiểm soát quyền truy cập của người dùng đối với các đối tượng trong cơ sở dữ liệu.
